...
<x-jet-dialog-modal wire:model="ConfirmStatusChangeModal">
    <x-slot name="title">
        Are you sure?

        <button
            wire:click="closeModal('ConfirmStatusChangeModal')"
            type="button"
    ...
    <x-slot name="content">
        <div class="p-6 text-center">
            ...
            <button wire:click.prevent="confirmedChangeStatus()" type="button"
            ...
            <button wire:click="closeModal('ConfirmStatusChangeModal')" wire:loading.attr="disabled" type="button"
