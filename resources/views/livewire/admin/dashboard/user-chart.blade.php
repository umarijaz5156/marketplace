<div class="w-full max-w-full px-3 mt-0 mb-6 lg:mb-0 lg:w-5/12 lg:flex-none">
    <div
        ...
        <div class="flex-auto p-4">
            ...
            <p class="ml-2 leading-normal text-sm">
                ...
                @endif
                <span class="font-bold {{ $usersIncOrDec < 0 ? 'text-red-500' : 'text-lime-500' }}">{{ abs($usersIncOrDec) }}%</span> than last week
            </p>
            <div class="w-full px-6 mx-auto max-w-screen-2xl rounded-xl">
                <div class="flex flex-wrap mt-0 -mx-3">
                    <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                        ...
                        <h4 class="font-bold">{{ number_format($users['users']) }}</h4>
                    ...
                    <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                        <div class="flex mb-2">
                            ...
                            <p class="mt-1 mb-0 font-semibold leading-tight text-xs">Admins</p>
                        </div>
                        <h4 class="font-bold">{{ number_format($users['admins']) }}</h4>
                        <div class="text-xs h-0.75 flex w-3/4 overflow-visible rounded-lg bg-gray-200">
                    ...
                    <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                        <div class="flex mb-2">
                            ...
                            <p class="mt-1 mb-0 font-semibold leading-tight text-xs">Ticket Managers</p>
                        </div>
                        <h4 class="font-bold">{{ number_format($users['ticket_managers']) }}</h4>
                        <div class="text-xs h-0.75 flex w-3/4 overflow-visible rounded-lg bg-gray-200">
                    ...
                    <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                        <div class="flex mb-2">
                            ...
                            <p class="mt-1 mb-0 font-semibold leading-tight text-xs">Sellers</p>
                        </div>
                        <h4 class="font-bold">{{ number_format($users['sellers']) }}</h4>
                        <div class="text-xs h-0.75 flex w-3/4 overflow-visible rounded-lg bg-gray-200">
    ...
    @push('scripts')
        <script>
            ...
            type: "bar",
            data: {
                labels: ["Jan "+year, "Feb "+year ,"Mar "+year ,"Apr "+year, "May "+year, "Jun "+year, "Jul "+year, "Aug "+year, "Sep "+year, "Oct "+year, "Nov "+year, "Dec "+year].splice(0, new Date().getMonth() + 1),
                datasets: [
                {
                    label: "Users",
                    tension: 0.4,
