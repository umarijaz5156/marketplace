<div class="mx-8">
    <div class="w-full flex flex-col bg-[#F4F6FC] ChatArea h-[90vh] overflow-y-auto" id="chatBox">
        <!-- Chat Header -->
            ...
            <div class="flex w-full items-center justify-between mb-5">
                <div class="flex items-center cursor-pointer transition-all duration-200 relativ">
                    <div class="w-full overflow-hidden">
                        ...
                        <a href="{{ route('admin.order_details', ['order' => $chat->order_id]) }}"><h2 class="">Order # {{ $chat->order_id }}</h2></a>
                    </div>
                </div>
        ...
        <div class="flex-grow p-[30px] lg:p-[30px_60px] ">
            ...
            {{-- Chat Area Component --}}
            <x-AdminPanel.ticket.chat-area :chat="$chat" />
            ...
            <form wire:submit.prevent="sendMessage" class="sticky bottom-0">
                ...
                <div class="flex items-center py-2 px-3 bg-gray-50 rounded-lg drk:bg-gray-700">
                    ...
                    <input wire:model="message" type="text" id="chat" rows="1"
    ...
    <script>
        ...
        window.addEventListener('gotoLastMessage', event => {
