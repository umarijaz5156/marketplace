<div>
    ...
    <h2 id="accordion-collapse-heading-4">
        <button type="button"
            ...
            data-accordion-target="#accordion-collapse-affiliate-configs" aria-expanded="false"
            aria-controls="accordion-collapse-affiliate-configs">
            <span>Affiliate Configuration</span>
    ...
    <div wire:ignore.self id="accordion-collapse-affiliate-configs" class="hidden"
        aria-labelledby="accordion-collapse-heading-4">
        <div class="p-5 border border-b-0 border-gray-200 drk:border-gray-700 drk:bg-gray-900">

            <form wire:submit.prevent="updateCommissionSettings">
                @csrf
                ...
                <div class="grid gap-3 mb-6 md:grid-cols-2 lg:grid-cols-3">
                    <div class="">
                        ...
                        <x-AdminPanel.form.input wire:model.defer="comissionPercentage" name="comission_percentage"
                            type="number" min="1" />
                    </div>
                    ...
                    {{-- <div class="">
                        ...
                        <x-AdminPanel.form.input wire:model="refundComissionPercentage"
                            name="refund_comission_percentage" type="number" min="1" />
                    </div> --}}
                </div>
