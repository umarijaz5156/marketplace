<nav
class="fixed w-full z-20 top-0 start-0 transition-all duration-300 ease-in bg-white shadow-md"
>
  <div class="container xl:max-w-screen-2xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
      <ul
        ...
        <li>
          <a href="{{ route('home') }}"
            class="block py-2 px-3 text-black bg-blue-700 rounded md:bg-transparent md:p-0 nunito-sans text-lg font-semibold"
            :class="{ 'md:!text-black': scrolled }" aria-current="page">Home</a>
        </li>
        <li>
          <a href="{{ route('home.search_gigs') }}" :class="{ 'md:!text-black': scrolled }"
            class="block py-2 px-3 text-black bg-blue-700 rounded md:bg-transparent md:p-0 nunito-sans text-lg font-semibold">Services</a>
        </li>
        <li>
          <a href="{{ route('requests') }}" :class="{ 'md:!text-black': scrolled }"
            class="block py-2 px-3 text-black bg-blue-700 rounded md:bg-transparent md:p-0 nunito-sans text-lg font-semibold">Jobs</a>
        </li>

        @if(!Auth::check() || (Auth::check() && !Auth::user()->is_seller))
        <li>
            <a href="{{ route('seller-register') }}" :class="{ 'md:!text-black': scrolled }"
              class="block py-2 px-3 text-black bg-blue-700 rounded md:bg-transparent md:p-0 nunito-sans text-lg font-semibold">Become Seller</a>
          </li>
        <li class="md:hidden">
          <a href="{{route('seller-register')}}" :class="{ 'md:!text-black': scrolled }"
