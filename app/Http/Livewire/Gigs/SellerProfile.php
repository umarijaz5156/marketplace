...
use App\Models\Seller\Seller as SellerSeller;
use App\Models\Seller\SellerProfile as Seller;
...
class SellerProfile extends Component
{
    ...
    public function checkIsOwner()
    {
        ...
        if(auth()->check()){
            $seller = SellerSeller::where('id', $this->seller->id)->first(['id', 'user_id']);
            if($seller){
    ...
    public function render()
    {
        ...
        $this->sellerDetails = Seller::where('seller_id', $this->seller->id)->first();
        ...
        return view('livewire.gigs.seller-profile', [
            'reviews' => $reviews,
